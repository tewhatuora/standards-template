...
<div style={{ textAlign: 'left' }}>
  <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'left', gap: '80px', padding: '20px' }}>
    <img src="/standards-tmplate/imgmwnz.svg" alt="Middleware New Zealand"  style={{ width: '10%' }} />
    <img src="/standards-tmplate/imgtwo.svg" alt="Health NZ"  style={{ width: '25%' }} />
    <img src="/standards-tmplate/imghiso-logo.png" alt="Hiso"  style={{ width: '25%', height:'30%' }} />
  </div>
  <br/>
